...
[[_getmatchprofilebymatchprofileidusingget]]
=== getMatchProfileByMatchProfileId
....
GET /matchProfile
....
...
|===
|HTTP Code|Description|Schema
|**200**|OK|<<_matchprofile,MatchProfile>>
|===
...
[[_getexpiredincompleterecordsusingget]]
=== getExpiredIncompleteRecords
....
GET /matcher/result
....
...
[[_getallpupperprofileswithfiltersusingget]]
=== getAllPupperProfilesWithFilters
....
GET /pupper
....
